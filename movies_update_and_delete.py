...
def show_films(cursor, title):
    ...
    # iterate over the data and output the results to the terminal window.
...
sqlInsert = "INSERT INTO film (film_name, film_releaseDate, film_runtime, film_director, studio_id, genre_id) VALUES ('M3GAN', '2022', '142', 'Gerard Johnstone', '2', '2')"
