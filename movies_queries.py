...
# Select the movie names for the movies that have a run time of less than 118 minutes
...
# Use a for loop printing the required film columns
for film in film:
    print("Film Name:", film[0])
